...
class TestGroupedCRBACorrectness:
    def test_quadruped_grouped_eq_aba(self):
        ...
        np.testing.assert_allclose(
            qddot_grouped, qddot_aba, atol=1e-10, err_msg="Grouped CRBA != ABA for quadruped"
        )
    ...
    def test_humanoid_grouped_eq_aba(self):
        ...
        np.testing.assert_allclose(
            qddot_grouped, qddot_aba, atol=1e-9, err_msg="Grouped CRBA != ABA for humanoid"
        )
    ...
    def test_chain_falls_back_to_standard(self):
        ...
        np.testing.assert_allclose(
            qddot_grouped, qddot_aba, atol=1e-10, err_msg="Grouped CRBA != ABA for chain (should fallback)"
        )
    ...
    def test_with_external_forces(self):
        ...
        np.testing.assert_allclose(
            qddot_grouped, qddot_aba, atol=1e-10, err_msg="Grouped CRBA != ABA with external forces"
        )
    ...
    def test_grouped_eq_monolithic_crba(self):
        ...
        np.testing.assert_allclose(
            qddot_grouped, qddot_mono, atol=1e-10, err_msg="Grouped CRBA != monolithic CRBA"
        )
