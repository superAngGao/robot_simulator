"""
Simple AABB (Axis-Aligned Bounding Box) self-collision detection.

Uses the penalty method: when two body AABBs overlap, a linear spring
force is applied along the axis of minimum penetration to push them apart.
...
This is intentionally simple: it prevents gross interpenetration (e.g. a
leg swinging through the torso) without the overhead of exact geometry.
"""
...
class AABBSelfCollision:
    ...
    Typical usage::
        ...
        self_forces = sc.compute_forces(X_world_list, tree.num_bodies)
