...
if _HAS_WARP:
    ...
    def _device_scene_bvh_first_hit_kernel(
        ...
        while stack_size > 0:
            ...
            node_hit = _intersect_aabb_for_ray(
                ox,
                oy,
                oz,
                dx,
                dy,
                dz,
                bvh_bounds_min[node_index, 0],
                bvh_bounds_min[node_index, 1],
                bvh_bounds_min[node_index, 2],
                bvh_bounds_max[node_index, 0],
                bvh_bounds_max[node_index, 1],
                bvh_bounds_max[node_index, 2],
                best_t,
            )
            if node_hit:
                ...
                if leaf_count > 0:
                    ...
                    if right >= 0:
                        right_hit = _intersect_aabb_for_ray(
                            ox,
                            oy,
                            oz,
                            dx,
                    ...
                    if left >= 0:
                        left_hit = _intersect_aabb_for_ray(
                            ox,
                            oy,
                            oz,
                            dx,
